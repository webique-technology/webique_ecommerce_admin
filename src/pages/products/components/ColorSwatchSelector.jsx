...
export default function ColorSwatchSelector({
    ...
    // 1. Ensure colors is always an array
    const colorList = Array.isArray(colors) ? colors : [];

    // 2. Ensure selectedColors is always an array
    const selectedList = Array.isArray(selectedColors) ? selectedColors : [];
        ...
        <>
            ...
            <div className="flex flex-wrap gap-4">
                {colorList.map((color, index) => {
                    const selected = selectedList.includes(color);
